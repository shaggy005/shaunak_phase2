...
## Solution:
- oh my sweet summer child did this one take my time
...
## Concepts learnt:
- pure grit and determination and concentration and never give up atitude frfrfrfr
...
## Solution:
- i see that the file has a .sal extension
- i searched in the web for this extension and see that it can be opened with Salae Logic 2
- I installed it and opened the file
- Then I had to study a bit about what this software is and how it works
- the desc said something about what the logic and files have in common so i added an async analyser on channel 3, used baud rate estimate extension
- then opened the terminal and voila some readable text, there i found the flag
...
## Concepts learnt:
- UART signals and where they are used
...
## Solution:
- i searched around in the internet for the .elf extension ad found out that its used as an executable for microcontrollers
- i ran a file command on it and found out that its an executable for an Atmel AVR 8-bit device

```
shaunak@Shaunaks-MacBook-Pro bare-metal-alchemist % file firmware.elf 
...
k= 11 flag= T{ydlyjf
                    TT}
k= 11 flag= yjf{dgbenxTneo
                          TT}
k= 11 flag= TTnn{ydfTneo
                        TT}
k= 46 flag= ojc{v.ojm.ojm}
k= 57 flag= 9mnxtk9mn{k9mnzk9mnjk9mn}
k= 66 flag= HBB{vBALxIyI
                        Q}
k= 107 flag= mzjyjhcpcNcxnkkkjzk{mzjyjhcpcNcxnkkk}
